...
export function Habit () {
  ...
  async function fetchHabits() {
    try {
      ...
      console.log(error)
      Alert.alert("Ops", "não foi possivel carregar as informações das tarefas")
    }
     finally {
      setLoading(false);
    }
  ...
  async function handleToggleHabit(habitId: string){
    try {
      ...
      console.log(error)
      Alert.alert("Ops", "não foi possivel atualizar o status da tarefa!")
    }
      ...
      >
...

        {
          ...
          <Text className='text-white mt-10 text-center'>
            Você não pode editar uma tarefa antiga!
          </Text>
        }
